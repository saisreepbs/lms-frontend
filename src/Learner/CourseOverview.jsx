export default function CourseOverview({ onBack, onContent }) {
return (
<div>
...
<button onClick={onContent} className="flex-1 py-2">Content</button>
</div>
...
<button className="px-3 py-1 border rounded">View Content</button>
</div>
